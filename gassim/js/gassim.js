...
export class World {
    ...
    */
    get num_particles() {
        ...
        _assertNum(this.ptr);
        const ret = wasm.__wbg_get_world_num_particles(this.ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    */
    set num_particles(arg0) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        _assertNum(arg0);
        wasm.__wbg_set_world_num_particles(this.ptr, arg0);
    }
    /**
    * @param {number} width
    * @param {number} height
    ...
    * @param {number} mass
    * @param {number} heat
    * @param {number} _van_der_waals
    * @returns {World}
    */
    static new(width, height, gravity, num_particles, radius, mass, heat, _van_der_waals) {
        _assertNum(num_particles);
        const ret = wasm.world_new(width, height, gravity, num_particles, radius, mass, heat, _van_der_waals);
    ...
    * @param {number} n
    */
    add_particles(x, y, radius, mass, heat, n) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        _assertNum(n);
        wasm.world_add_particles(this.ptr, x, y, radius, mass, heat, n);
    }
    /**
    * @param {number} x
    * @param {number} y
    * @param {number} radius
    */
    remove_particles(x, y, radius) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.world_remove_particles(this.ptr, x, y, radius);
    }
    /**
    * @param {number} mass
    * @param {boolean} horizontal
    */
    add_wall(mass, horizontal) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        _assertBoolean(horizontal);
        wasm.world_add_wall(this.ptr, mass, horizontal);
    }
    /**
    */
    remove_wall() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.world_remove_wall(this.ptr);
    }
    /**
    * @returns {number}
    */
    update_positions() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.world_update_positions(this.ptr);
        return ret;
    }
    /**
    * @returns {number}
    */
    step() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.world_step(this.ptr);
        return ret;
    }
    /**
    * @param {number} x
    ...
    * @param {number} factor
    */
    temperature(x, y, radius, factor) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.world_temperature(this.ptr, x, y, radius, factor);
    }
    /**
    * @returns {number}
    */
    timestep() {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        const ret = wasm.world_timestep(this.ptr);
        return ret;
    }
    /**
    ...
    */
    set_timestep(timestep) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.world_set_timestep(this.ptr, timestep);
    }
    /**
    ...
    */
    gravity() {
        try {
            ...
            _assertNum(this.ptr);
            wasm.world_gravity(retptr, this.ptr);
    ...
    */
    set_gravity(gravity) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.world_set_gravity(this.ptr, gravity);
    }
}
...
function getImports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_ea9df5fefa8f404d = function() { return logError(function (arg0, arg1) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('gassim_bg.wasm', import.meta.url);
    }
    const imports = getImports();
