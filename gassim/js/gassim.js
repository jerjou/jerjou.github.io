...
export class World {
    ...
    * @param {number} mass
    * @param {number} heat
    * @param {number} van_der_waals
    * @returns {World}
    */
    static new(width, height, gravity, num_particles, radius, mass, heat, van_der_waals) {
        const ret = wasm.world_new(width, height, gravity, num_particles, radius, mass, heat, van_der_waals);
    ...
    */
    gravity() {
        const retptr = 8;
        const ret = wasm.world_gravity(retptr, this.ptr);
...
function init(module) {
    ...
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_ea9df5fefa8f404d = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_get_a7395f826d52f42a = function(arg0, arg1) {
        try {
